...
::: {.column width="50%"}
We are passionate about writing research software well [^1]. Please talk to us about software, we like to help.
:::
::::
...
::: {.column width="50%"}
* initial Python experience
* initial `git` experience
* a GitHub account
